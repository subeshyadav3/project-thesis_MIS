...
const proposalCommentRoutes = require('./routes/proposalComments');
...
app.get('/api/stats', authenticate, async (req, res) => {
  try {
    ...
    const deptThesisFilter = departmentId && !programId ? { student: { program: { departmentId } } } : {};
    const thesisFilter = programId ? { student: { programId } } : deptThesisFilter;
