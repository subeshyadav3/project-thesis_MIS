...
router.post('/bulk-import', authenticate, authorize('COORDINATOR'), upload.single('file'), groupController.bulkImportPreview);
router.post('/bulk-import/confirm', authenticate, authorize('COORDINATOR'), groupController.bulkImportConfirm);
